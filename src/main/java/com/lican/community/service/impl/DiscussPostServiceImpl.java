...
public class DiscussPostServiceImpl implements DiscussPostService {
    ...
    //帖子列表的缓存
    private LoadingCache<String, List<DiscussPostEntity>> postListCache;
    ...
    public void init(){
        ...
        postListCache = Caffeine.newBuilder()
                ...
                .build(new CacheLoader<String, List<DiscussPostEntity>>() {
                    @Override
                    public @Nullable List<DiscussPostEntity> load(@NonNull String key) throws Exception {
    ...
    @Override
    public List<DiscussPostEntity> findDiscussPosts(int userId, int offset, int limit, int orderMode) {
